    ...
    return (<div className="flex justify-center items-center pt-20">
        <div className="flex flex-col  justify-center items-center p-2 space-y-5 w-2/5  ">
            ...
            <label className="input input-bordered flex items-center gap-2 bg-primary">
                ...
                <input type="text" className="grow" placeholder="Verification Code" id={"verify-input"}/>
            </label>
            <button className="btn btn-active btn-primary" onClick={submitVerificationRequest}></button>
            <p>Need another verification code? <button className="underline">Request Another</button></p>
        </div>
    </div>)
}
